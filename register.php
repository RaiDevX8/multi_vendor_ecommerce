                    ...
                    <form id="cregister-frm" action="" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label for="firstname" class="control-label">First Name</label><span id="message1">*</span>
                                <input type="text" id="firstname" autofocus name="firstname" class="form-control form-control-sm form-control-border"  onblur="validateName()" required>
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                <label for="lastname" class="control-label">Last Name</label><span id="message2">*</span>
                                <input type="text" id="lastname" name="lastname" class="form-control form-control-sm form-control-border"onblur="validateName()" required>
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="password" id="password" name="password" class="form-control form-control-sm form-control-border" onblur="validatePassword()" required>
                        ...
                        <div class="row align-item-end">
                            ...
                            <!-- /.col -->
                            <div class="col-4">
                                <button type="submit" id="submit" class="btn btn-primary btn-block btn-flat">Create Account</button>
                            </div>
