        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php 
                    $i = 1;
                    $orders = $conn->query("SELECT * FROM `payment_list` order by `status` asc,unix_timestamp(date_created) desc ");
                    ...
                    <tr>
                        ...
                        <td class="px-2 py-1 align-middle text-right"><?= format_num($row['total_amount']*0.15) ?></td>
