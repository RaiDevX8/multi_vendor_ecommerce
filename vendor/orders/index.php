            ...
            <table class="table table-bordered table-striped">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="p1 text-center">Amount Recieved</th>
                ...
                <tbody>
                    <?php 
                    $i = 1;
                    $orders = $conn->query("SELECT * FROM `payment_list` where vendor_id = '{$_settings->userdata('id')}' order by `status` asc,unix_timestamp(date_created) desc ");
                    ...
                    <tr>
                        ...
                        <td class="px-2 py-1 align-middle text-right"><?= format_num($row['total_amount']*0.85) ?></td>
